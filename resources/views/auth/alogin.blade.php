...
<head>
	...
	<link rel="stylesheet" href="assets_front/css/jquery-ui.min.css"/>
...
<body>
	...
	<section class="hero-section">
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="assets_front/img/bg.jpg">
				<div class="container">
					<div class="row">
			...
			<div class="hs-item set-bg" data-setbg="assets_front/img/bg-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							<span>New Arrivals</span>
	...
	<script src="assets_front/js/jquery.nicescroll.min.js"></script>
	<script src="assets_front/js/jquery.zoom.min.js"></script>
